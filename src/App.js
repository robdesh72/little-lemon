...
function App() {
  return (
    <div className="App">
      <header>
        <img src="/images/header-logo.png" alt="Little Lemon Restaurant" />
      </header>
      ...
      <main id="home">
        ...
        <section className="content-cards">
          <article id="menu">
            ...
            />
            <p>
              Try our new seasonal menu featuring special Mediterranean dishes
          ...
          <article id="reservations">
            ...
            />
            <p>
              Join us for a relaxed Mediterranean dining experience with family
              and friends.
            </p>
          </article>
